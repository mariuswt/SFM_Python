...
print(f"Extrahiert: {formated_string[first_index + 1:second_index]}")
...
#
# print(f"Fließkommazahl eingegeben:  {number_input} \n"
#       f"Vorkommaanteil:             {int(number_input)} \n"
#       f"Nachkommaanteil:            { round(number_input - int(number_input) , 6) } \n")
#
#
